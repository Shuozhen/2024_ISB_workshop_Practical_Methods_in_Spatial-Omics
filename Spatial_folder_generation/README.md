...
Everything detailed in https://github.com/Shuozhen/DBiT-Notes
   ...
   18. Use the jupyter notebook code _metadata.ipynb_ to generate the spatial foder for downstream analysis
